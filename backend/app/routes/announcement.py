...
from app.schemas.announcement import AnnouncementCreation, AnnouncementOut
...
async def create_announcement(payload: AnnouncementCreation, x_api_key: Optional[str] = Depends(require_admin), session: AsyncSession = Depends(get_session)):
